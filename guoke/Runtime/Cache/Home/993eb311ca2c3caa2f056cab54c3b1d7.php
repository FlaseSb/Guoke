...
<div class="gwrap ask-success-page">
        
<div class="gmain">
    <div style="width:650px;height:90px;background:#F1EEEE;text-align:center;padding-top:20px;font:15px 'Microsoft Yahei';">
        <h2 style="font-size:20px;color:#178A25;">
	    	√你的答案已经提交成功！
        </h2>
        <a href="<?php echo U('Home/Question/subject',array('id'=>$sub_id));?>">查看原问题</a>
        <p style="color:#B5B5B5;">感谢你来果壳贡献智慧，因为你，果壳问答将越来越聪明。</p>
    </div>
    <div class="ask-txt-list">
        <h3 style="font:18px 'Microsoft Yahei';color:#178A25;margin:12px 0;">
            还有一些问题等待你来回答
        </h3>
        <ul class="ask-q-list">
            <?php if(is_array($que)): foreach($que as $key=>$vo): ?><li>
	                <span class="ask-list-right"><?php echo ($vo["answer_num"]); ?>回答</span>
	                <a class="gellipsis" href="<?php echo U('Home/Question/subject',array('id'=>$vo['id']));?>"><?php echo ($vo["sub_name"]); ?></a>
	            </li><?php endforeach; endif; ?>
        </ul>
        <a href="<?php echo U('Home/Question/waitque');?>" class="more-q-link" style="float: right;color:#858585;">查看更多问题</a>
    </div>
</div>
