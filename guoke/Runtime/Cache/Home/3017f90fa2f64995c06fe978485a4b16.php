...
<html class="no-js screen-scroll">
    <head>
        ...
        <link rel="stylesheet" href="/Public/Home/assets/Content/bc4bd704.main.css" />
    
    <link rel="stylesheet" href="/Public/Home/assets/Content/920d0c10.index.css" />
...
<div class="gheader-new">
    ...
    <!-- 导航   -->
    <div class="gh-sub-nav-wrap" id="subNav" style="margin-top:-10px">
    ...
    <?php if(is_array($res)): foreach($res as $key=>$v): ?><li class="oneli"><a href="<?php echo U('Home/Science/index',array('id'=>$v['id']));?>"><?php echo ($v['Class_Title']); ?></a><a href=""><i class="gnarrow-down"></i></a></li><?php endforeach; endif; ?>            
    

            </ul>
            <a class="icon icon-file" href="/scientific/all/archive/" title="点击查看归档"></a>
    ...
    <div class="container">
        <div id="innerNav" class="gh-inner-nav-wrap">
            <div class="gh-inner-nav">
                <h2><span class="gh-inner-nav-title">学科</span></h2>
                <ul class="gh-inner-nav-list">

                    
                    <li class="current">
                        <a href="/scientific/subject/">全部</a>
                    </li>
