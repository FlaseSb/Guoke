    ...
    <div class="main">
        ...
        <div class="cmts" id="comments">
            ...
            <?php if (!empty($hot)): ?>
                ...
                <?php if(is_array($hot)): foreach($hot as $key=>$v): ?><li class="reply3001172">
...
<?php if(is_array($commentres)): foreach($commentres as $key=>$v): ?><li class="reply3001172">
        <div class="cmt-img cmtImg pt-pic">
...
<?php endif ?>
    ...
    <div class="side">
        ...
        <div class="author-info  clearfix">
                ...
                #">
                    <img src="/Public<?php echo ($res["User_pic"]); ?>" alt="<?php echo ($res["User_Nickname"]); ?>">
                </a>
...
<script type="text/javascript">
    ...
    <?php if (isset($_SESSION['Home']) && !empty($_SESSION['Home'])): ?>
        ...
        $('.commentdel').click(function(){
            ...
            //url
            var url="<?php echo U('Home/Article/ajaxcommentdel');?>";
            //this赋值
            var td=$(this);
            //ajax删除
