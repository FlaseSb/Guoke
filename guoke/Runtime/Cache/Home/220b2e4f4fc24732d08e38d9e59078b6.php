...
<html class="no-js screen-scroll">
    <head>
        ...
        <meta name="Keywords" content="文艺科学,果壳小组, 果壳,果壳网,科技,泛科技,智趣,生活,科普"/>
        <meta name="Description" content="想为果壳网写稿，分享你的学识与见解？

请和我联系：wuouou@guokr.com

我们欢迎如下写作者：

1. 如果你对科学写作保有热情，希望磨练你的选题能力和写作技巧，欢迎请加入我们的“科学人的秘密发动机”。在那里，我将和科学人的编辑们就你的作品与你进行讨论，给出建议。你可以联系我领取邀请码..."/>
...
<body>
    ...
    <!-- 引入公共的导航文件 -->
        <div id="spread" class="spread" style="clear: both;">
    <script type="text/javascript" >BAIDU_CLB_SLOT_ID = "1087247";</script>
    <script type="text/javascript" src="/Public/Home/Article/js/o.js"></script>
    <a href="javascript:void 0;" class="icon-close" style="position: absolute;margin-top: -14px;top: 50%;right:     3px;padding: 5px;background-position: 5px 5px;background: url('../Images/d6823053.icon-close.png') no-repeat;width: 22.5px;height:    22.5px;background-size: 22.5px 22.5px;"></a>
</div>
...
<li>
<a href="http://www.guokr.com/scientific/">科学人<b class="gnarrow-up"></b></a>
</li>
...
<a href="http://www.guokr.com/group/185/" target="_blank">果壳动漫</a>
    ...
    <div class="gh-login">
        <a rel="nofollow" href="http://www.guokr.com/sso/?suppress_prompt=1&amp;lazy=y&amp;success=http%3A%2F%2Fwww.guokr.com%2Farticle%2F441438%2F">登录</a>
        <span class="split">|</span>
        <a rel="nofollow" href="https://account.guokr.com/sign_up/?success=http%3A%2F%2Fwww.guokr.com%2Fsso%2F%3Fsuppress_prompt%3D1%26lazy%3Dy%26success%3Dhttp%253A%252F%252Fwww.guokr.com%252Fgroup%252Fuser%252Frecent_replies%252F">注册</a>
    </div>
	...
	<div class="gwrap">
			...
			<div class="group-info-inner">
				<div class="group-info-detail">
                    <div class="group-info-name">
                        <h3>选择分类　</h3>
                            <select onchange="change(this)" name="Fid">
                                <!-- 取出顶级分类 -->
                            ...
                            <select id="city" name="Fid" style="display:none">
        ...
        <div class="gbottom-i">
            ©2015果壳网&nbsp;京ICP备09043258号-2&nbsp;京公网安备1101052730
        </div>
    </div>
