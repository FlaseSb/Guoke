        ...
        <div class="gside">
            ...
            <ul class="m-nav">
                ...
                <li class="gactived"><span class="gicon-message"></span>站内信</li>
                 <li><span class="gicon-draft"></span><a href="<?php echo U('Home/Email/been');?>">已发送信箱</a></li>
...
<div class="gmain">
    <div class="page-titleline">
        <a href="<?php echo U('Home/Email/add');?>" class="gnbtn-primary gfr">写信</a>
        <h2>站内信</h2>
        <a href="javascript: void 0;" class="msg_now" id="msgNow">
            ...
            <?php else: ?> 
                未读<?php endif; ?>
            <span class="gicon-msg"></span>
        </a>
    </div>
    <div class="msg_filter" id="msgFilter">
        <a href="<?php echo U('Home/Email/index',array('num'=>1));?>">全部</a>
        <a href="<?php echo U('Home/Email/index',array('num'=>2));?>">已读</a>
        <a href="<?php echo U('Home/Email/index',array('num'=>3));?>">未读</a>
    </div>
    ...
    <ul class="main-message" id="msgList">
        ...
        <?php if(is_array($res)): foreach($res as $key=>$vo): ?><li>
            <div class="pt-pic">
                <a href="http://www.guokr.com/i/1007513324/" target="_blank" title="果壳网服务生">
            ...
            <div class="pt-txt">
                <p><a href="http://www.guokr.com/i/1007513324/" target="_blank"><?php echo ($vo["User_Nickname"]); ?></a>发来：<?php echo ($vo["msg"]); ?></p>
                <p class="pt-txt-d">
                    ...
                    <span class="gfr">
                        ...
                        <?php if($vo["state"] == 0 ): ?><a>未读</a>
                        <?php else: ?>
                            <a>已读</a><?php endif; ?>
                        <span class="gsplit">|</span>
                        <a href="<?php echo U('Home/Email/see',array('id'=>$vo['id'],'uid'=>$vo['uid']));?>">查看</a>
                        <span class="gsplit">|</span>
                        <a href="<?php echo U('Home/Email/add',array('pid'=>$vo['uid']));?>">回复</a>
                    </span>
                </p>
            </div>
