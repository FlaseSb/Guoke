...
<div class="gmain">
    ...
    <ul class="gntabs">
	    <li <?php if($num == 1): ?>class="gtabs-curr"<?php endif; ?> ><a href="<?php echo U('Home/Question/question',array('num'=>'1'));?>">热门问答</a></li>
	    
	    <li <?php if($num == 2): ?>class="gtabs-curr"<?php endif; ?> ><a href="<?php echo U('Home/Question/question',array('num'=>'2'));?>">精彩回答</a></li>
	    
	    <li <?php if($num == 3): ?>class="gtabs-curr"<?php endif; ?> ><a href="<?php echo U('Home/Question/question',array('state'=>3,'num'=>'3'));?>">大家都喜欢</a></li>
	    
	    <li <?php if($num == 4): ?>class="gtabs-curr"<?php endif; ?> ><a href="<?php echo U('Home/Question/question',array('state'=>4,'num'=>'4'));?>">等待支持</a></li>
    </ul>
    <?php if($que != '' ): ?><ul class="ask-list-cp">
	    	<?php if(is_array($que)): foreach($que as $key=>$vo): ?><li>
		            <div class="ask-hot-nums">
		                ...
		                <span class="num"><?php echo ($vo["answer_num"]); ?></span>回答
		                </p>
		            </div>
		            <div class="ask-list-detials">
		                <h2>
		                	<a target="_blank" href="<?php echo U('Home/Question/subject',array('id'=>$vo['id']));?>">
		                ...
		                <div class="ask-list-legend">
					    	...
					    	<?php if(is_array($vo['tag_name'])): foreach($vo['tag_name'] as $key=>$v): ?><a target="_blank" href="<?php echo U('Home/Quetag/tag',array('tag_id'=>$v['tag_id']));?>" class="tag">
			                    	<?php echo ($v["tag_name"]); ?>
    ...
    <?php if($likeans != '' ): ?><ul class="ask-multi-list ask-multi-current">
	    	<?php if(is_array($likeans)): foreach($likeans as $key=>$vo): ?><li class="gclear">
		        ...
		        <div class="gfl">
		            <h4 class="gellipsis">
		                <a href="http://www.guokr.com/ask/i/1049918203/"><?php echo ($vo["User_Nickname"]); ?></a>&nbsp;回答&nbsp;<a href="<?php echo U('Home/Question/subject',array('id'=>$vo['id']));?>" target="_blank"><?php echo ($vo["sub_name"]); ?></a>
		            </h4>
		            <p class="gellipsis">
		                <?php echo ($vo["ans_msg"]); ?>
		            </p>
	...
	<?php if($waitans != '' ): ?><ul class="ask-multi-list ask-multi-current">
