...
<div class="gheader-new">
	...
	<div class="sub-nav">
	    <div class="sub-nav-wrap gclear">
	        ...
	        <div class="sub-nav-btn gfr">
	            ...
	            <a href="<?php echo U('Home/Question/waitque');?>" data-gaevent="ask_nav_button_answer:ask" class="gnbtn-primary">我要回答</a>
	        </div>
	    </div>
	</div>
	...
	<div class="gmain">
	    ...
	    <ul class="gntabs">
		    ...
		    <li <?php if($num == 1): ?>class="gtabs-curr"<?php endif; ?> ><a href="<?php echo U('Home/Quetag/index',array('is_hot'=>1,'num'=>'1'));?>">热门标签</a></li>
		    
		    <li <?php if($num == 2): ?>class="gtabs-curr"<?php endif; ?> ><a href="<?php echo U('Home/Quetag/index',array('state'=>2,'num'=>'2'));?>">人文·社科</a></li>
		    
		    <li <?php if($num == 3): ?>class="gtabs-curr"<?php endif; ?> ><a href="<?php echo U('Home/Quetag/index',array('state'=>3,'num'=>'3'));?>">科学·技术</a></li>
		    
		    <li <?php if($num == 4): ?>class="gtabs-curr"<?php endif; ?> ><a href="<?php echo U('Home/Quetag/index',array('state'=>4,'num'=>'4'));?>">生活·娱乐</a></li>
		    
		    <li <?php if($num == 5): ?>class="gtabs-curr"<?php endif; ?> ><a href="<?php echo U('Home/Quetag/index',array('state'=>5,'num'=>'5'));?>">自然·生态</a></li>
	    </ul>
	    <ul class="join-list">
		    <!-- 遍历标签 -->
			<?php if(is_array($res)): foreach($res as $key=>$vo): ?><li style="margin-top:20px;border-bottom:1px dashed #CBC7C7;float: left;width: 300px;height:90px;position: relative;padding-left:20px;">
