        ...
        <div style="margin:30px;">
            <div>
                <p class="post-tags tags tags-edit" id="tagContent" >
                     <!-- <span class="tag"><a href="">水</a><a href="javascript: void 0;" class="gnicon-close-small" title="移除标签" data-operation="delete">X</a><input type="hidden" name="tags" value="水"></span>  -->
                 </p>
