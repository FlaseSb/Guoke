         ...
         <div class="row">
              ...
              <div class="panel panel-default bk-bg-white">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-2 number">
                      <div class="bk-margin-bottom-10">
                        ...
                        <ul class="dropdown-menu" role="menu">
                           <li><a href="<?php echo U('Admin/Scienceaudit/index',array('num'=>2));?>">显示条数:2</a></li>
                           <li><a href="<?php echo U('Admin/Scienceaudit/index',array('num'=>5));?>">显示条数:5</a></li>
                           <li><a href="<?php echo U('Admin/Scienceaudit/index',array('num'=>10));?>">显示条数:10</a></li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/Scienceaudit/index');?>" method="get">
                          <div class="input-group input-search">
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><table class="table table-bordered table-striped mb-none" id="datatable-editable">
                        <thead>
                          <tr>
                            ...
                            <th width="200px">文章ID</th>
                            <th width="300px">发表用户账号</th>
                            <th>上传时间</th>
                          </tr>
                        </thead>
                        <tr class="gradeX">
                          <td rowspan="3" class="sid"><?php echo ($v["Img"]); ?></td>
                          <td class="ssid edit_name classname"><?php echo ($v["id"]); ?></td>
                          <td class="disp"><?php echo ($v["User_Email"]); ?></td>
                        ...
                        <tr>
                          ...
                          <td class="actions">
                            ...
                            　
                            <a href="#" class="on-default edit-row btn_edit" title="打回文章"><i class="fa fa-reply"></i></a>
                            　
                          </td>
                        </tr>
                      </table>
          ...
          <script type="text/javascript">
            ...
            $('.compile').click(function(){
              ...
              //url
              var url="<?php echo U('Admin/Scienceaudit/ajaxaudit');?>";
              //ajax审核通过
              $.post(url, {id:id});
              //this赋值
              var td=$(this);
