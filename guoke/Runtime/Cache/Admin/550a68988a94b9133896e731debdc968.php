    ...
    <div class="container-fluid content"> 
      ...
      <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="panel panel-default bk-bg-white">
                <div class="panel-heading bk-bg-white">
                  <h6><i class="fa fa-table red"></i><span class="break"></span>以处理举报列表</h6>              
                      ...
                      <thead>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-center" style="vertical-align: middle;" colspan="1">
                              <a class="btn btn-danger" id="del" rid="<?php echo ($vo["r_id"]); ?>">删除举报</a>
          ...
          $('#del').live('click',function(){
            ...
            var url="<?php echo U('Admin/Report/isdel');?>";
