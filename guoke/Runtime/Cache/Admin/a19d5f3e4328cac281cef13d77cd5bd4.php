                 ...
                 <!--  <div class="panel-body text-center">                
                  ...
                  <li class="nav-parent">
                    ...
                    <ul class="nav nav-children">
                      ...
                      <li><a href="<?php echo U('Admin/User/index');?>"><span class="text">文章管理</span></a></li>
              ...
              <div class="panel panel-default bk-bg-white">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/Scienceclass/subclass');?>" method="get">
                          <div class="input-group input-search">
