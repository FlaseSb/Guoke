              ...
              <div class="panel panel-default bk-bg-white">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/User/userlist');?>" method="get">
                          <div class="input-group input-search">
                  ...
                  <table class="table table-bordered table-striped mb-none" id="datatable-editable">
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="gradeX">
                        <td><img src="<?php echo ($v["pic"]); ?>" width="50px" alt=""></td>
                        <td id="sid"><?php echo ($v["id"]); ?></td>
                        <td class="edit_name"><?php echo ($v["username"]); ?></td>
