            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="panel panel-default bk-bg-white">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="bk-margin-bottom-10">
                        ...
                        <a href="<?php echo U('Admin/User/add');?>" id="addToTable" class="btn btn-info">Add<i class="fa fa-plus"></i></a>
                    ...
                    <div class="btn-group col-sm-6">
                       ...
                       <ul class="dropdown-menu" role="menu">
                          ...
                          <li><a href="<?php echo U('Admin/User/index',array('page'=>2));?>">2</a></li>
                          <li><a href="<?php echo U('Admin/User/index',array('page'=>5));?>">5</a></li>
                          <li><a href="<?php echo U('Admin/User/index',array('page'=>10));?>">10</a></li>
                    ...
                    <div class="col-sm-4">
                      ...
                      <form class="search navbar-form"  action="<?php echo U('Admin/User/index');?>" method="get">
                  ...
                  <table class="table table-bordered table-striped mb-none ziti lh" id="datatable-editable" style="text-align:center">
                    <thead>
                      <tr>
                        <th class="ct">头像</th>
                        <th class="ct">ID</th>
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="gradeX">
                        <td width="10%"><img src="/Public<?php echo ($v["User_pic"]); ?>" width="50px" alt=""></td>
                        <td id="sid" width="10%" class="lh"><?php echo ($v["U_id"]); ?></td>
                        <td class="edit_name lh" width="30%" height="45px"><?php echo ($v["User_Email"]); ?></td>
                        <td width="5%" id="edit_sex" class="lh"><?php echo ($v["User_Age"]); ?></td>
                        <td width="15%" id="edit_NK" class="lh"><?php echo ($v["User_Nickname"]); ?></td>
                        <td width="15%"id="edit_Addre" class="lh"><?php echo ($v["User_Address"]); ?></td>
