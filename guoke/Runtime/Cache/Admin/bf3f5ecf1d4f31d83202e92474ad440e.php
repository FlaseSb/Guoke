...
<html lang="en">
  ...
  <body>
        ...
        <div class="page-header">
            <div class="pull-left">
              <ol class="breadcrumb visible-sm visible-md visible-lg">                
                ...
                <li class="active"><i class="fa fa-laptop"></i>管理成员</li>
              </ol>           
            </div>
            <div class="pull-right">
              <h2>Dashboard</h2>
        ...
        <div style="background-color: white;width:60%;" class="center-block">
          <div class="panel-body">
                  <form action="<?php echo U('Admin/Sciencearticle/update');?>" method="post" class="form-horizontal">
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><div class="form-group">
                        <input class="hidden" type="hidden" value="<?php echo ($v["uid"]); ?>">
                        <label class="col-md-2 control-label" for="email-input"><i class="fa fa-user"></i></label>
                        <div class="col-md-7">
                          <input type="text" id="password-input" class="form-control" value="<?php echo ($v["Admin_name"]); ?>" disabled="disabled">
                        </div>
                   ...
                   <a href="javascript:history.go(-1);" class="bk-margin-5 btn btn-success btn-sm subm" style="margin:0px auto">返 回</a>
                   </div>
                    <br>
                  </form>
                </div>
    ...
    $('.del').click(function() {
      ...
      var uemail=$(this).parents('.form-group').find('#password-input').val();
      //url
      var url="<?php echo U('Admin/Jurisdiction/ajaxadmindel');?>"
      //转移this
      var td=$(this);
      //ajax删除
