                 ...
                 <!--  <div class="panel-body text-center">                
                  ...
                  <li class="nav-parent">
                    ...
                    <ul class="nav nav-children">
                      <li><a href="<?php echo U('Admin/User/index');?>"><span class="text"> 权限</span></a></li>
                      <li><a href="<?php echo U('Admin/User/add');?>"><span class="text"> 权限添加</span></a></li>

                      <li><a href="<?php echo U('Admin/User/edit');?>"><span class="text"> 权限管理</span></a></li>
                  ...
                  <li class="nav-parent">
                    ...
                    <ul class="nav nav-children">
                      ...
                      <li><a href="<?php echo U('Admin/Sciencereport/index');?>"><span class="text"> 举报管理</span></a></li>
	...
	<div class="row" >
        ...
        <div class="col-sm-2">
          <div class="bk-margin-bottom-10">
            <a href="/Admin/Group/add.html" class="btn btn-info">Add<i class="fa fa-plus"></i></a>
          </div>
        </div>
        
        <div class="btn-group col-sm-6">

           <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="background-color: #B8ECE5;">
               
                  显示条数                          <span class="caret"></span>
           </button>
           <ul class="dropdown-menu" role="menu">
              <li><a href="/Admin/group/index/page/8.html">8</a></li>
              <li><a href="/Admin/group/index/page/12.html">12</a></li>
              <li><a href="/Admin/group/index/page/32.html">32</a></li>
           </ul>
        </div>
        
        <div class="col-sm-4">
          <form class="search navbar-form" action="/Admin/group/index.html" method="get">
              <div class="input-group input-search">
...
<div class="media-gallery" style="margin-top:-20px" >
	<div class="mg-main" >							
		<div class="row mg-files" data-sort-id="media-gallery" style="position: relative; height: 0px;">
			<?php if(is_array($res)): foreach($res as $key=>$v): ?><div class="isotope-item document col-sm-6 col-md-4 col-lg-3" >
				<div class="thumbnail">
					<div class="thumb-preview">
						<a class="thumb-image" href="">
							<img src="/Public<?php echo ($v["Group_Src"]); ?>" class="img-responsive" alt="Project">
						</a>
						<div class="mg-thumb-options">
							<div class="mg-zoom"><a href="<?php echo U('Admin/Group/Audit',array(id=>$v['G_id']));?>"><i class="fa fa-search"></i></a></div>
							<div class="mg-toolbar">
							</div>
						</div>
					</div>
					<h6 class="ziti" style='font-size:16px;color:#abcdef'><?php echo ($v["Group_Name"]); ?></h6>
					<div class="mg-description" style="margin-top:15px">
						<small class="pull-left text-muted bk-fg-warning">创始人: <?php echo ($v["User_Nickname"]); ?></small>
						<small class="pull-right text-muted bk-fg-primary"><?php echo (date("Y-m-d",$v["Group_Ctime"])); ?></small>
					</div>
				</div>
