              ...
              <div class="panel panel-default bk-bg-white">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="bk-margin-bottom-10">
                        <a href="<?php echo U('Admin/BiBo/add');?>" id="addToTable" class="btn btn-info">Add<i class="fa fa-plus"></i></a>
                      </div>
                    </div>
                    ...
                    <div class="btn-group col-sm-6">
                       ...
                       <ul class="dropdown-menu" role="menu">
                          <li><a href="<?php echo U('Admin/BiBo/index',array('page'=>2));?>">2</a></li>
                          <li><a href="<?php echo U('Admin/BiBo/index',array('page'=>5));?>">5</a></li>
                          <li><a href="<?php echo U('Admin/BiBo/index',array('page'=>10));?>">10</a></li>
                       </ul>
                    </div>
                    
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/BiBo/index');?>" method="get">
                          <div class="input-group input-search">
                  ...
                  <table class="table table-bordered table-striped mb-none ziti" id="datatable-editable" style="text-align:center">
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="gradeX">
                        <td id="sid" width="10%"><?php echo ($v["BiBo_id"]); ?></td>
                        <td width="13%" height="45px"><span class="edit_name title cu" ><?php echo ($v["BiBo_title"]); ?></span></td>
                        <td width="14%" id="edit_sex" ><span class="cont cu"><?php echo ($v["BiBo_Controller"]); ?></span></td>
                        <td width="5%" id="edit_NK">
                        <?php if($v["Display"] == 0): ?><span class="glyphicon glyphicon-eye-open xianshi" style="color:green;cursor:pointer" value="0"></span></td>
                        <?php else: ?> 
                            <span class="glyphicon glyphicon-eye-close xianshi" style="color:#ccc;cursor:pointer" value="1"></span></td><?php endif; ?>
