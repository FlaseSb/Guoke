    ...
    <div class="container-fluid content"> 
      ...
      <div class="row">
                ...
                <div class="panel-body" id="prent">
                 <!--  <div id="detailed">
                  ...
                  <div class="row">
                    ...
                    <div class="btn-group col-sm-8">
                       ...
                       <ul class="dropdown-menu" role="menu">
                          <li><a href="<?php echo U('Admin/Quecomment/index',array('page'=>5));?>">5</a></li>
                          <li><a href="<?php echo U('Admin/Quecomment/index',array('page'=>10));?>">10</a></li>
                          <li><a href="<?php echo U('Admin/Quecomment/index',array('page'=>15));?>">15</a></li>
                       </ul>
                    </div>
                    
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/Quecomment/index');?>" method="get">
                          <div class="input-group input-search">
                  ...
                  <div class="panel-body">
                    排序方式:
                      <a href="<?php echo U(Admin/Quecomment/index,array('name'=>'ans_id','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">ID <span class="glyphicon glyphicon-sort"></span></a>
                      <a href="<?php echo U(Admin/Quecomment/index,array('name'=>'zan','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">支持数<span class="glyphicon glyphicon-sort"></span></a>
                      <a href="<?php echo U(Admin/Quecomment/index,array('name'=>'is_like','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">是否喜欢 <span class="glyphicon glyphicon-sort"></span></a>
                      <a href="<?php echo U(Admin/Quecomment/index,array('name'=>'is_like','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">发布时间 <span class="glyphicon glyphicon-sort"></span></a>
                    </div>
                  ...
                  <?php if(is_array($res)): foreach($res as $k=>$vo): ?><table class="table table-bordered table-striped mb-none" id="datatable-editable" style="margin-top:15px;">
                      <thead>
                        ...
                        <tr class="text-center id">
                          <td><h4><?php echo ($vo["ans_id"]); ?></h4></td>
                          <td><h4><?php echo ($vo["User_Nickname"]); ?></h4></td>
                          <td><h4><?php echo ($vo["zan"]); ?></h4></td>
                          <td>
                            <?php if($vo["is_like"] == 0 ): ?><a state="0" id="is_hot" ansid="<?php echo ($vo["ans_id"]); ?>" class="bk-margin-5 btn btn-warning btn-circle"><i class="fa fa-times"></i></a>
                            <?php else: ?>
                              <a state="1" id="is_hot" ansid="<?php echo ($vo["ans_id"]); ?>" class="bk-margin-5 btn btn-default btn-circle"><i class="fa fa-check"></i></a><?php endif; ?>
                          </td>
                          <td rowspan="4" class="text-center" style="vertical-align: middle;">
                            <a href="<?php echo U('Admin/Quecomment/save',array('id'=>$vo['id']));?>" class="btn btn-warning">修改</a>
                        ...
                        <tr class="text-center">
                          ...
                          <td >
                            <a class="btn btn-info" id="msg" msg="<?php echo ($vo["msg"]); ?>">详细描述</a>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="4">
          ...
          $('#del').live('click',function(){
            var url="<?php echo U('Admin/Quecomment/ajaxdel');?>";
          ...
          $('#is_hot').live('click',function(){
            ...
            // 设置url
            var url="<?php echo U('Admin/Quecomment/ajaxhot');?>";
            // alert(id);
            var hot=$(this);
            // 判断状态
            if(state==1){
