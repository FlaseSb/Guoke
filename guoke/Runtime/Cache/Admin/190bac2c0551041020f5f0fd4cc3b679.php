...
<html lang="en">
  ...
  <body>
	...
	<div class="row" >
		<?php if($res == null ): ?><div class="alert alert-info">
					<button type="button" class="close" data-dismiss="alert">×</button>
					<strong>warm tips!</strong> 当前无审核信息
				</div>
			<?php else: ?> 
		<?php if(is_array($res)): foreach($res as $k=>$v): ?><div class="col-sm-4">		
					<div class="panel panel-default bk-bg-white">
						<div class="panel-heading bk-bg-white">
							<h6><i class="fa fa-indent red"></i>申请表</h6>							
						...
						<div class="panel-body">
							<!--内容  -->
							<address>
							  <strong class="ziti" style="font-size:15px;color:#abcdef">申请组名:<?php echo ($v["J_Name"]); ?></strong><br>
							  <br>
							  申请简介:<?php echo ($v["J_About"]); ?><br><br>
							  申请时间:<?php echo ($v["J_ctime"]); ?><br><br>
							  申请人:<?php echo ($v["User_Nickname"]); ?>
							  <br>
							 
							</address>
							<address>
							  联系邮箱:<a href="mailto:#"><?php echo ($v["User_Email"]); ?></a>
							  <a class="btn btn-success" href="<?php echo U('Admin/Group/look',array('id'=>$v['id'],'name'=>$v['User_Nickname']));?>" role="button" style="float:right">审核</a>
							</address>
							<!--  -->
						</div>
					</div>
				</div><!--/.col-->
				<?php if(($k+1)%3==0 ): ?><div style="clear:both"></div>
					<div style="width:100%;height:1px;"></div><?php endif; endforeach; endif; endif; ?>
	</div>			
