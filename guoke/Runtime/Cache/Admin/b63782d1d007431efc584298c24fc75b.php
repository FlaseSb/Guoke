      ...
      <div class="row">
        ...
        <div style="background-color: white;width:60%;" class="center-block">
          <div class="panel-body">
                  ...
                  <form action="<?php echo U('Admin/Jurisdiction/groupAdminSave');?>" method="post" class="form-horizontal" enctype="multipart/form-data">

                    <input type="hidden" name="group_id" value="<?php echo ($id); ?>">
                    <div class="form-group">
                      <label class="col-md-3 control-label" for="text-input">管理组名:</label>
                      <label class="col-md-3 control-label" for="text-input"><?php echo ($admin); ?></label>
                    </div>
                    ...
                    <div id="list">
                    <?php if(is_array($adminres)): foreach($adminres as $key=>$v): ?><div class="form-group" style="height:20 px;">
                      <label class="col-md-3 control-label" for="email-input">管理员<?php echo ($v["A_ID"]); ?>:</label>
                      <div class="col-md-9" style="padding-top:4px;">
                        <input type="checkbox" name="uid[]" value="<?php echo ($v["A_ID"]); ?>" class="checkadmin" onclick="change(this)"> <?php echo ($v["Admin_name"]); ?>
                      </div>
