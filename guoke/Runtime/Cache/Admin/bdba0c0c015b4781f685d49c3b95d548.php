         ...
         <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="bk-margin-bottom-10">
                        <a href="<?php echo U('Admin/Scienceclass/add');?>" id="addToTable" class="btn btn-info">Add <i class="fa fa-plus"></i></a>
                      </div>
                    </div>
                    ...
                    <div class="btn-group col-sm-6">
                       ...
                       <ul class="dropdown-menu" role="menu">
                          <li><a href="<?php echo U('Admin/User/userlist',array('page'=>2));?>">2</a></li>
                          <li><a href="<?php echo U('Admin/User/userlist',array('page'=>5));?>">5</a></li>
                          <li><a href="<?php echo U('Admin/User/userlist',array('page'=>10));?>">10</a></li>
                       </ul>
                    </div>
                    
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/Scienceclass/index');?>" method="get">
                          <div class="input-group input-search">
                            <input type="text" class="form-control bk-radius seekcname" name="keyword" id="q" placeholder="请输入分类名...">
                  ...
                  <table class="table table-bordered table-striped mb-none" id="datatable-editable">
                    <thead>
                      <tr>
                        ...
                        <th width="350px">顶级分类名</th>
                        <!-- <th>查看子分类</th> -->
                        <th>是否显示(双击以更改)</th>
                        <th width="300px">操作 ([查看子分类],编辑,删除)</th>
                      </tr>
                    </thead>
                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="gradeX" height="40px">
                        <td class="sid"><?php echo ($v["id"]); ?></td>
                        <td class="edit_name classname"><?php echo ($v["Class_Title"]); ?></td>
                        <td class="disp"><?php echo ($v["display"]); ?></td>
                        <td class="actions">
                          <!-- if判断标志,是否显示显示子类按 -->
                          <?php if($v['son'] == 1 ): ?>　
                            <a href="<?php echo U('Admin/Scienceclass/subclass',array('id'=>$v['id']));?>" class="on-default edit-row btn_edit" title="查看子分类"><i class="fa fa-bars"></i></a><?php endif; ?>
                          　
          ...
          <script type="text/javascript">
            ...
            $('.confirm').click(function() {
              ...
              // var td=$(this);
              //ajax修改
              var url="<?php echo U('Admin/Scienceclass/ajaxReva');?>";
            ...
            $('.del').click(function(){
              //获取id
              var id=($(this).parents('tr').find('.sid').html());
              var url="<?php echo U('Admin/Scienceclass/ajaxDel');?>";
              var td=$(this);
              //ajax删除
            ...
            $('.seekcname').keyup(function() {
              var val=$('.seekcname').val();
              var url="<?php echo U('Admin/Scienceclass/ajaxSeek');?>";
              $.post('url', {Class_Title:val}, function(data) {
