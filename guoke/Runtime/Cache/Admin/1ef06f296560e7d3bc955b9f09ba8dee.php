                 ...
                 <!--  <div id="detailed">
                  ...
                  <div class="panel-body col-md-7">
                    排序方式:
                      ...
                      <a href="<?php echo U(Admin/Quetag/index,array('name'=>'is_hot','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">热门 <span class="glyphicon glyphicon-sort"></span></a>
                    </div>
                      ...
                      <thead>
                        ...
                        <tr class="text-center id">
                          ...
                          <td rowspan="2" class="text-center" style="vertical-align: middle;">
                            <a href="<?php echo U('Admin/Quetag/save',array('id'=>$vo['id']));?>" class="btn btn-warning">修改</a>
                        ...
                        <tr class="text-center">
                          ...
                          <td id="hp">
                            ...
                            <?php else: ?>
                              <img width="48px" height="48px" src="<?php echo ($vo["tag_img"]); ?>" alt=""><?php endif; ?>
                          </td>
                          ...
                          <td colspan="4">
                            <?php echo (substr($vo["tag_msg"],0,300)); ?>
                          </td>
