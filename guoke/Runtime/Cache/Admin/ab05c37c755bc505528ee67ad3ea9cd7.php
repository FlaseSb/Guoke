  ...
  <body>
    ...
    <div class="container-fluid content"> 
      <div class="row">
        ...
        <div class="page-header">
            <div class="pull-left">
              <ol class="breadcrumb visible-sm visible-md visible-lg">                
                <li><a href="<?php echo U('User/index');?>"><i class="icon fa fa-home"></i><?php echo ($admin); ?></a></li>
        ...
        <div style="background-color: white;width:60%;" class="center-block">
          ...
          <div class="panel-body">
                  <form action="<?php echo U('Admin/Jurisdiction/update');?>" method="post" class="form-horizontal">
                    
                    <input class="hidden" name="gid" type="hidden" value="<?php echo $_GET['id'] ?>">

                    <div class="for-group">
                      <div class="col-md-12 text-center" style="height:40px"><?php echo ($admin); ?></div>
                    </div>
                    ...
                    <!-- 已有权限 -->
                    <?php if(is_array($existingAuthority)): foreach($existingAuthority as $key=>$v): ?><div class="form-group">
                        <input class="hidden" type="hidden" value="<?php echo ($v["id"]); ?>">
                        <label class="col-md-2 control-label" for="email-input"><i class="fa fa-legal"></i></label>
                        <div class="col-md-7">
                          <input type="text" id="password-input" class="form-control" value="<?php echo ($v["title"]); ?>" disabled="disabled">
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div id="list">
                      <?php if(is_array($optionalPermissions)): foreach($optionalPermissions as $key=>$v): ?><div class="form-group" style="height:20 px;">
                          <label class="col-md-2 control-label" for="email-input">权限模块<?php echo ($v["id"]); ?>:</label>
                          <div class="col-md-9" style="padding-top:4px;">
                            <input type="checkbox" name="rules[]" value="<?php echo ($v["id"]); ?>" class="checkadmin" onclick="change(this)"> <?php echo ($v["title"]); ?>
                          </div>
                        </div><?php endforeach; endif; ?>
                      </div>
    ...
    //可选权限
        ...
        $('.del').click(function() {
          ...
          //url
          var url="<?php echo U('Admin/Jurisdiction/ajaxjurisdictiondel');?>";
          //转移this
          var td=$(this);
          //ajax删除
