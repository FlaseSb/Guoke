                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="bk-margin-bottom-10">
                        <a href="<?php echo U('Admin/User/add');?>" class="btn btn-info">Add<i class="fa fa-plus"></i></a>
                      </div>
                    </div>
                    ...
                    <div class="btn-group col-sm-6">
                       ...
                       <ul class="dropdown-menu" role="menu">
                          <li><a href="<?php echo U('Admin/User/edit',array('page'=>2));?>">2</a></li>
                          <li><a href="<?php echo U('Admin/User/edit',array('page'=>5));?>">5</a></li>
                          <li><a href="<?php echo U('Admin/User/edit',array('page'=>10));?>">10</a></li>
                       </ul>
                    </div>
                    
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/User/edit');?>" method="get">
                          <div class="input-group input-search">
                  ...
                  <table class="table table-bordered  mb-none ziti" id="datatable-editable" style="text-align:center;">
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="gradeX">
                        <td width="10%" class="lh"><img src="/Public<?php echo ($v["User_pic"]); ?>" width="50px" height="50px" alt=""></td>
                        <td id="sid" width="10%" class="lh"><?php echo ($v["U_id"]); ?></td>
                        <td class="edit_name lh" width="20%" height="45px"><?php echo ($v["User_Email"]); ?></td>
                        <td width="15%" class="lh"><span class="edit_pwd" style='cursor:pointer'>点击修改</span></td>
                        <td width="7%" class="edit_age lh"><?php echo ($v["User_Age"]); ?></td>
                        <td width="15%" class="edit_NK lh"><?php echo ($v["User_Nickname"]); ?></td>
                        <td width="15%"class="edit_Addre lh"><?php echo ($v["User_Address"]); ?></td>
                        <td class="actions">
