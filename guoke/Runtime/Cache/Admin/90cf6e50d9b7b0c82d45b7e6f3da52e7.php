         ...
         <div class="row">
              ...
              <div class="panel panel-default bk-bg-white">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-2 number">
                      <div class="bk-margin-bottom-10">
                        ...
                        <ul class="dropdown-menu" role="menu">
                           <li><a href="<?php echo U('Admin/Sciencecomment/index',array('num'=>2));?>">显示条数:2</a></li>
                           <li><a href="<?php echo U('Admin/Sciencecomment/index',array('num'=>5));?>">显示条数:5</a></li>
                           <li><a href="<?php echo U('Admin/Sciencecomment/index',array('num'=>10));?>">显示条数:10</a></li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/Sciencecomment/index');?>" method="get">
                          <div class="input-group input-search">
                  ...
                  <?php if(is_array($res)): foreach($res as $key=>$v): ?><table class="table table-bordered table-striped mb-none" id="datatable-editable">
                      ...
                      <tr class="gradeX">
                        ...
                        <td class="ssid edit_name classname"><?php echo ($v["User_Email"]); ?></td>
                        <td><?php echo ($v["wid"]); ?></td>
                        <td><?php echo ($v["Title"]); ?></td>
                        <td rowspan="3" class="cimg"><?php echo ($v["Cm_Content"]); ?></td>
                      </tr>
                      <tr>
                        <th>是否删除(隐藏)</th>
                        <th>评论时间</th>
                        <th>点赞数量</th>
                        <th>操作(
                        <?php if($v["likeCount"] != 0): ?>查看点赞用户,<?php endif; ?>
                        编辑，隐藏)</th>
                      </tr>
                      <tr>
                        <td class="disp"><?php echo ($v["Delete"]); ?></td>
                        <td><?php echo ($v["Cm_Time"]); ?></td>
                        <td><?php echo ($v["likeCount"]); ?></td>
                        <td class="actions">
                          <?php if($v["likeCount"] != 0): ?><a href="<?php echo U('Admin/Sciencecomment/see',array('id'=>$v['id']));?>" class="on-default remove-row btn_del" title="查看点赞用户"><i class="fa fa-smile-o"></i></a><?php endif; ?>　

                          <a href="<?php echo U('Admin/Sciencecomment/reva',array('id'=>$v['id']));?>" class="on-default edit-row btn_edit compile" title="编辑评论内容"><i class="fa fa-pencil"></i></a>　

                          <?php if($v["Delete"] == '否'): ?><a href="javascript:love(0);" class="on-default edit-row btn_edit compile display" title="显示"><i class="fa fa-eye"></i></a>
                          ...
                          <?php else: ?>
                            ...
                            <a href="javascript:love(0);" class="on-default edit-row btn_edit compile hides" title="隐藏"><i class="fa fa-eye-slash"></i></a><?php endif; ?>
                          　
                          　
                        </td>
                      </tr>
          ...
          <script type="text/javascript">
            ...
            $('.del').click(function(){
              ...
              //url
              var url="<?php echo U('Admin/Sciencecomment/ajaxdel');?>";
              //ajax删除
              $.post(url, {id:id});
              //this赋值
              var td=$(this);
            ...
            $('.display').click(function(){
              //url
              var url="<?php echo U('Admin/Sciencecomment/ajaxupdatehide');?>";
              //id
            ...
            $('.hides').click(function(){
              //url
              var url="<?php echo U('Admin/Sciencecomment/ajaxupdatedisplay');?>";
              //id
              var id=$(this).parents('table').find('.sid').html();
              //赋值this
              var td=$(this);
