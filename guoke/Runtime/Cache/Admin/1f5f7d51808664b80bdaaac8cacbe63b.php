    ...
    <div class="container-fluid content"> 
      <div class="row">
        ...
        <div class="page-header">
            <div class="pull-left">
              <ol class="breadcrumb visible-sm visible-md visible-lg">                
                <li><a href="<?php echo U('User/index');?>"><i class="icon fa fa-home"></i>管理组</a></li>
        ...
        <div style="background-color: white;width:60%;" class="center-block">
          <div class="panel-body">
                  ...
                  <form action="<?php echo U('Admin/Jurisdiction/save');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div id="list">
                    <?php if(is_array($ruleres)): foreach($ruleres as $key=>$v): ?><div class="form-group" style="height:20 px;">
                      <label class="col-md-3 control-label" for="email-input">管理组权限<?php echo ($v["id"]); ?>:</label>
                      <div class="col-md-9" style="padding-top:4px;">
                        <input type="checkbox" name="rules[]" value="<?php echo ($v["id"]); ?>"> <?php echo ($v["title"]); ?>
                      </div>
                    ...
                    <div id="lists">
                    <?php if(is_array($adminres)): foreach($adminres as $key=>$v): ?><div class="form-group">
                      <label class="col-md-3 control-label" for="email-input">管理组成员<?php echo ($v["A_ID"]); ?>:</label>
                      <div class="col-md-9" style="padding-top:4px;">
                        <input type="checkbox" name="uid[]" value="<?php echo ($v["A_ID"]); ?>"> <?php echo ($v["Admin_name"]); ?>
                      </div>
                    </div><?php endforeach; endif; ?>
                    </div>
    ...
    <script>
      ...
      $(function(){
        ...
        $("#text-input").keyup(function() {
          ...
          //url
          var url="<?php echo U('Admin/Jurisdiction/ajaxGroupName');?>"
          //ajax
