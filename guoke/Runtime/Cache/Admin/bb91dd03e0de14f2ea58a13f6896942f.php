      ...
      <div class="row">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="bk-margin-bottom-10">
                        ...
                        <a href="<?php echo U('Admin/Jurisdiction/add');?>" id="addToTable" class="btn btn-info">Add<i class="fa fa-plus"></i></a>
                  ...
                  <table class="table table-bordered table-striped mb-none ziti lh" id="datatable-editable">
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="gradeX">
                        ...
                        <td class="disp"><?php echo ($v["status"]); ?></td>
                        <td>
                            
                            <!-- if判断标志,是否有组成员 -->
                            <?php if($v['son'] == 1 ): ?><a href="<?php echo U('Admin/Jurisdiction/admins',array('id'=>$v['id']));?>" class="on-default edit-row btn_edit" title="查看管理员"><i class="fa fa-bars"></i></a>　<?php endif; ?>

                            
                            <a href="<?php echo U('Admin/Jurisdiction/edit',array('id'=>$v['id']));?>" class="on-default edit-row btn_edit compile" title="编辑"><i class="fa fa-pencil"></i></a>　


                            <a href="#" class="del on-default remove-row btn_del" title="删除"><i class="fa fa-trash-o"></i></a>　

                             <!-- if判断标志,是否有组成员 -->
                            <?php if($v['addadmin'] == 1 ): ?><a href="<?php echo U('Admin/Jurisdiction/groupAdd',array('id'=>$v['id']));?>" class="on-default edit-row btn_edit" title="添加管理员"><i class="fa fa-plus"></i></a>　<?php endif; ?>
                        </td>
        ...
        <script type="text/javascript">
          ...
          $('.disp').dblclick(function() {
            ...
            var td=$(this);
            //ajax url
            var url="<?php echo U('Admin/Jurisdiction/ajaxReva');?>";
            //ajax修改是否显示
          ...
          $('.del').click(function(){
            ...
            var id=$(this).parents('tr').find('.sid').html();
            // alert(id);
            var url="<?php echo U('Admin/Jurisdiction/ajaxdel');?>";
            var td=$(this);
            //ajax删除
