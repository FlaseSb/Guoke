         ...
         <div class="row">
              ...
              <div class="panel panel-default bk-bg-white">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-2 number">
                      <div class="bk-margin-bottom-10">
                        ...
                        <ul class="dropdown-menu" role="menu">
                           <li><a href="<?php echo U('Admin/Chat/index',array('num'=>2));?>">显示条数:2</a></li>
                           <li><a href="<?php echo U('Admin/Chat/index',array('num'=>5));?>">显示条数:5</a></li>
                           <li><a href="<?php echo U('Admin/Chat/index',array('num'=>10));?>">显示条数:10</a></li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/Chat/index');?>" method="get">
                          <div class="input-group input-search">
                  ...
                  <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="gradeX">
                        ...
                        <td class="ssid edit_name classname actions"><?php echo ($v["uid"]); ?></td>
                        <td class="disp actions"><?php echo ($v["User_Nickname"]); ?></td>
                        <td class="actions"><?php echo ($v["chattext"]); ?></td>
          ...
          <script type="text/javascript">
            ...
            $('.del').click(function(){
              ...
              //url
              var url="<?php echo U('Admin/Chat/ajaxdel');?>";
              //this赋值
              var td=$(this);
              //ajax删除
