  ...
  <script type="text/javascript" charset="utf-8" src="/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
    ...
    <div class="panel panel-default bk-bg-white" id="fram" style="position:fixed;width:600px;right:350px;top:150px;z-index:100;background:black;display:none;">
                ...
                <div class="panel-body">
                  <form class="form-horizontal " method="post" action="<?php echo U('Admin/Email/reply');?>">
        ...
        <!-- 发信 -->
         <div class="panel panel-default bk-bg-white" id="sendframe" style="position:fixed;width:600px;right:350px;top:150px;z-index:100;background:black;display:none;">
                ...
                <div class="panel-body">
                  <form class="form-horizontal " method="post" action="<?php echo U('Admin/Email/send');?>">
      ...
      <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="btn-group col-sm-10">
                       ...
                       <ul class="dropdown-menu" role="menu">
                          <li><a href="<?php echo U('Admin/Email/index',array('page'=>5));?>">5</a></li>
                          <li><a href="<?php echo U('Admin/Email/index',array('page'=>10));?>">10</a></li>
                          <li><a href="<?php echo U('Admin/Email/index',array('page'=>15));?>">15</a></li>
                       </ul>
                    </div>
                  <div class="col-sm-2 ">
                  ...
                  <?php if(is_array($res)): foreach($res as $k=>$vo): ?><table class="table table-bordered table-striped mb-none" id="datatable-editable" style="margin-top:15px;">
                      <thead>
                        ...
                        <tr class="id">
                          ...
                          <td><h4><?php echo ($vo["msg"]); ?></h4></td>
                          <td  rowspan="2" class="text-center" style="vertical-align: middle;">
                            <a id="reply" num="<?php echo ($vo["uid"]); ?>" uname="<?php echo ($vo["User_Nickname"]); ?>" class="btn btn-warning">回复</a>
          ...
          $('#del').live('click',function(){
            var url="<?php echo U('Admin/Email/del');?>";
            var id=$(this).attr('num');
            // 获取当前$this
            var del=$(this);
