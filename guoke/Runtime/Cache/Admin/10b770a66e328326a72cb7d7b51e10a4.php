    ...
    <div class="container-fluid content"> 
      ...
      <div class="row">
                ...
                <div class="panel-body" id="prent">
                 <!--  <div id="detailed">
                  ...
                  <div class="row">
                    ...
                    <div class="btn-group col-sm-8">
                       ...
                       <ul class="dropdown-menu" role="menu">
                          <li><a href="<?php echo U('Admin/Question/index',array('page'=>5));?>">5</a></li>
                          <li><a href="<?php echo U('Admin/Question/index',array('page'=>10));?>">10</a></li>
                          <li><a href="<?php echo U('Admin/Question/index',array('page'=>15));?>">15</a></li>
                       </ul>
                    </div>
                    
                    <div class="col-sm-4">
                      <form class="search navbar-form"  action="<?php echo U('Admin/Question/index');?>" method="get">
                          <div class="input-group input-search">
                  ...
                  <div class="panel-body">
                    排序方式:
                      <a href="<?php echo U(Admin/Question/index,array('name'=>'id','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">ID <span class="glyphicon glyphicon-sort"></span></a>
                      <a  href="<?php echo U(Admin/Question/index,array('name'=>'answer_num','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">回答数<span class="glyphicon glyphicon-sort"></span></a>
                      <a href="<?php echo U(Admin/Question/index,array('name'=>'follow_num','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">关注数 <span class="glyphicon glyphicon-sort"></span></a>
                      <a href="<?php echo U(Admin/Question/index,array('name'=>'is_hot','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">热门 <span class="glyphicon glyphicon-sort"></span></a>
                      <a href="<?php echo U(Admin/Question/index,array('name'=>'is_wonderful','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">精彩 <span class="glyphicon glyphicon-sort"></span></a>
                      <a href="<?php echo U(Admin/Question/index,array('name'=>'sub_time','num'=>$state));?>" class="bk-margin-5 btn btn-default btn-xs">发布时间 <span class="glyphicon glyphicon-sort"></span></a>
                    </div>
                      ...
                      <thead>
                        ...
                        <tr class="text-center id">
                          ...
                          <td rowspan="4" class="text-center" style="vertical-align: middle;">
                            <a href="<?php echo U('Admin/Question/save',array('id'=>$vo['id']));?>" class="btn btn-warning">修改</a>
                            <a num="<?php echo ($vo["id"]); ?>" uid="<?php echo ($vo["user_id"]); ?>" msg="<?php echo ($vo["sub_name"]); ?>" id="del" class="btn btn-danger">删除</a>
                          </td>
                        </tr>
                        <tr class="text-center">
                          <th class="text-center" style="vertical-align: middle;">是否热门</th>
                          <td><h4>
                            <?php if($vo["is_hot"] == 0 ): ?><a state="0" id="is_hot" class="bk-margin-5 btn btn-warning btn-circle"><i class="fa fa-times"></i></a>
                            <?php else: ?>
                              <a state="1" id="is_hot" class="bk-margin-5 btn btn-default btn-circle"><i class="fa fa-check"></i></a><?php endif; ?>
                            </h4>
                          </td>
                          <th class="text-center" style="vertical-align: middle;">是否精彩</th>
                          <td><h4>
                            <?php if($vo["is_wonderful"] == 0 ): ?><a state="0" id="is_wonderful" class="bk-margin-5 btn btn-warning btn-circle"><i class="fa fa-times"></i></a>
                            <?php else: ?>
                              <a state="1" id="is_wonderful" class="bk-margin-5 btn btn-default btn-circle"><i class="fa fa-check"></i></a><?php endif; ?>
                            </h4>
                          </td>
                        ...
                        <tr>
                          ...
                          <td colspan="3">
                            <?php echo (substr($vo["sub_msg"],0,300)); ?>
                          </td>
          ...
          $('#msg').live('click',function(){
            var url = "<?php echo U('Admin/Question/ajaxdetailed');?>";
          ...
          $('#del').live('click',function(){
            var url="<?php echo U('Admin/Question/ajaxdel');?>";
          ...
          $('#is_hot').live('click',function(){
            ...
            // 设置url
            var url="<?php echo U('Admin/Question/ajaxhot');?>";
          ...
          $('#is_wonderful').live('click',function(){
            ...
            // 设置url
            var url="<?php echo U('Admin/Question/ajaxwonderful');?>";
