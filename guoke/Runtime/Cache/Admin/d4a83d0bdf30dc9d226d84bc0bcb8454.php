    ...
    <div class="container-fluid content"> 
      ...
      <div class="row">
                      ...
                      <thead>
                        ...
                        <tr class="text-center id">
                          ...
                          <td  class="text-center" style="vertical-align: middle;">
                            <a class="btn btn-warning">完成处理</a>
                          </td>
                        </tr>
                        <tr class="text-center">
                          ...
                          <td class="text-center" style="vertical-align: middle;" colspan="1">
                              <a class="btn btn-danger" id="del" bid="<?php echo ($vo["bru_id"]); ?>" bm="<?php echo ($vo["b_r"]); ?>" om="<?php echo ($vo["o_r"]); ?>" msgid="<?php echo ($vo["rmsg_id"]); ?>" type="<?php echo ($vo["r_type"]); ?>" rid="<?php echo ($vo["r_id"]); ?>">删除举报</a>
          ...
          $('#del').live('click',function(){
            ...
            var del=$(this);
            $.post(url,{type:type,buid:buid,msgid:msgid,bm:bm,om:om,rid:rid},function(data){
              if(data==1){
