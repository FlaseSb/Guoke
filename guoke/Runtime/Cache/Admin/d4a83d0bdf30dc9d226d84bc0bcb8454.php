    ...
    <div class="container-fluid content"> 
      ...
      <div class="row">
              ...
              <div class="panel panel-default bk-bg-white">
                ...
                <div class="panel-body" id="prent">
                 <!--  <div id="detailed">
                  ...
                  <hr> 
                  <?php if($res == '' ): ?><h3>暂无举报信息</h3><?php endif; ?>
                  <?php if(is_array($res)): foreach($res as $k=>$vo): ?><table class="table table-bordered table-striped mb-none" id="datatable-editable" style="margin-top:15px;">
                      <thead>
                        ...
                        <tr class="text-center id">
                          <td>
                            <?php if($vo["r_type"] == 1 ): ?><a class="btn btn-default">问题</a>
                            <?php elseif($vo["r_type"] == 2): ?>
                              <a class="btn btn-info">回答</a><?php endif; ?>
                          </td>
                          <td><h4><?php echo ($vo['u'][0]['User_Nickname']); ?></h4></td>
                          <td><h4><?php echo ($vo["b_r"]); ?></h4></td>
                          <td><h4><?php echo ($vo["o_r"]); ?></h4></td>
                          <td>
                              <?php echo ($vo['bu'][0]['User_Nickname']); ?>
                          </td>
                          <td  class="text-center" style="vertical-align: middle;">
                            <a class="btn btn-warning" rid="<?php echo ($vo["r_id"]); ?>" id="delr">删除举报</a>
                          </td>
                        </tr>
                        <tr class="text-center">
                          <th class="text-center" style="vertical-align: middle">举报时间</th>
                          <td colspan="4"><h4><?php echo ($vo["r_time"]); ?></h4></td>
                          <td class="text-center" style="vertical-align: middle;" colspan="1">
                              <a class="btn btn-danger" id="del" bid="<?php echo ($vo["bru_id"]); ?>" bm="<?php echo ($vo["b_r"]); ?>" om="<?php echo ($vo["o_r"]); ?>" msgid="<?php echo ($vo["rmsg_id"]); ?>" type="<?php echo ($vo["r_type"]); ?>" rid="<?php echo ($vo["r_id"]); ?>" rmsg="<?php echo ($vo["r_msg"]); ?>">处理举报</a>
                        ...
                        <tr class="text-center">
                          ...
                          <td colspan="5">
                            <?php if($vo["r_type"] == 1 ): echo ($vo["r_msg"]); ?>
                            <?php elseif($vo["r_type"] == 2): ?>
                              <?php echo (substr($vo["r_msg"],0,500)); endif; ?>
                          </td>
                          <td class="text-center" style="vertical-align: middle;">
                            <a class="btn btn-info" id="msg" data-msg="<?php echo ($vo["msg"]); ?>">详细描述</a>
                          </td>
                        </tr>
                      </thead>
          ...
          $('#delr').live('click',function(){
              ...
              var rid=$(this).attr('rid');
              var d=$(this);
              var url="<?php echo U('Admin/Report/delr');?>";
