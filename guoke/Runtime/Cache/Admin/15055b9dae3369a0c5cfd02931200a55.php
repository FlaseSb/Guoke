                      ...
                      <thead>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <?php if($vo['merge'] != '' ): ?><a num="<?php echo ($vo["id"]); ?>" id="merge" class="btn btn-warning"  pid="<?php echo ($vo['merge'][0]['id']); ?>" msg="<?php echo ($vo['merge'][0]['sub_name']); ?>" uid="<?php echo ($vo['merge'][0]['user_id']); ?>">合并</a><?php endif; ?>
                          </td>
                        </tr>
                      </thead>
