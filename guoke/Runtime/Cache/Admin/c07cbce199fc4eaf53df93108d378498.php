    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="panel panel-default bk-bg-white">
        <div class="panel-heading bk-bg-white">
          <h6><i class="fa fa-table red"></i><span class="break"></span>问题修改</h6>              
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <form action="<?php echo U('Admin/Question/update');?>" method="post">
              <input type="hidden" name="id" value="<?php echo ($res["id"]); ?>">
            <table class="table table-bordered table-striped mb-none" id="datatable-editable">
              <thead>
                <tr>
                  <th class="text-center" style="vertical-align: middle;">问题</th>
                  <td>
                    <div class="form-group">
                      <div class="col-lg-10 col-md-10">
                        <textarea rows="3" class="form-control" style="width: 800px; height: 100px;" name="sub_name"><?php echo ($res["sub_name"]); ?></textarea>
                      </div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <script id="editor" name="sub_msg" type="text/plain" style="width:800px;height:400px;"><?php echo ($sub_msg); ?></script>
                  </td>
                </tr>
                <tr>
                  <th>操作</th>
