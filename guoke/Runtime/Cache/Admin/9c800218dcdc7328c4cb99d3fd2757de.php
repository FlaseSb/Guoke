        ...
        <div style="background-color: white;width:60%;" class="center-block">
          <div class="panel-body">
                  <form action="<?php echo U('Admin/Sciencearticle/update');?>" method="post" class="form-horizontal">
                    ...
                    <div class="for-group">
                      <div class="col-md-12 text-center" style="height:40px">点赞用户</div>
                    </div>

                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><div class="form-group">
                        <input class="hidden" type="hidden" value="<?php echo ($v["id"]); ?>">
                        <label class="col-md-2 control-label" for="email-input"><i class="fa fa-bullhorn"></i></label>
                        <div class="col-md-7">
                          <input type="text" id="password-input" class="form-control" value="<?php echo ($v["User_Email"]); ?>" disabled="disabled">
                        </div>
